# 📑 JARUS SORA 2.5 — Übersicht

> **Audit-Trail aller JARUS-Dokumente, die wir lokal archiviert haben.**
> Originaldateinamen bleiben erhalten (Zweck: Rückverfolgbarkeit zur Quelle).
...
| *eintragen* | 2024-06 | Annex C — Air Risk Mitigations | ~0,3 MB | `JARUS\` |
| *eintragen* | 2024-06 | Annex D — SAIL Determination | ~0,3 MB | `JARUS\` |
| *eintragen* | 2024-06 | Annex E — OSO Compliance | ~0,5 MB | `JARUS\` |
| *eintragen* | 2024-06 | Annex F — Population Density (Kernel) | ~1 MB | `JARUS\` |
| *eintragen* | 2024 | Glossary — Definitionen | ~0,2 MB | `JARUS\` |

---

## 🧭 Wofür ist welcher Annex?

### Main Body — die Grundlage
...
- **Adjacent Volume / Adjacent Area (AV)**
...
> **Was bedeutet welcher Begriff?**

---

## 📚 Wo du es heruntergeladen hast
...
| Datum | Was wurde aktualisiert | Wer |
|-------|----------------------|-----|
| *2026-09-22* | Initial — Main Body + Annex A bis F + Glossary lokal archiviert | User |

---

## 💡 Empfohlene Naming-Strategie (nachträglich, optional)
...
*Hinweis: Originaldateinamen werden beibehalten aus Gründen der Rückverfolgbarkeit
zu den JARUS-Quellen. Eine Übersichts-Datei (diese hier) dient als Audit-Trail.*
